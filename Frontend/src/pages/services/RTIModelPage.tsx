...
export const RTIModelPage: React.FC = () => {
  ...
  const submitApplicationWithoutPayment = async (data: typeof formData) => {
    try {
      ...
      // Fetch state by slug (default to Karnataka if not found)
      // Default state_id to Karnataka based on current database
      let stateId = 1; // Karnataka (update with actual ID from your database)
      try {
