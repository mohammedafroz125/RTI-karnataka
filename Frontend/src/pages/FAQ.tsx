...
export const FAQPage: React.FC = () => {
  ...
  const generalFAQs: FAQ[] = [
    ...
    {
      q: 'Can I file RTI for land records and Bhoomi portal in Karnataka?',
      a: 'Yes, you can file RTI applications for land records, RTC copies, mutation status, and related information from Karnataka Revenue Department, Bhoomi portal, and other relevant authorities. We help you draft and file RTI applications for land-related queries.'
    },
    {
  ...
  const karnatakaFAQs: FAQ[] = [
    ...
    },
    {
      ...
      a: 'No problem! Our expert team will identify the correct Karnataka department and Public Information Officer (PIO) based on your query. Just tell us what information you need, and we\'ll handle the rest. We maintain an extensive database of Karnataka departments and their PIOs.'
    },
    {
    ...
    {
      q: 'Which Karnataka departments can I file RTI to?',
      a: 'You can file RTI to all Karnataka State departments including Secretariat (Vidhana Soudha), Revenue Department, Police Department, Education, Health, Transport, BBMP, Municipal Administration, Registration & Stamps, Commercial Taxes, and all district offices. We cover all Karnataka departments and local bodies.'
    }
  ];
