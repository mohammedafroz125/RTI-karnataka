              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To democratize access to government information in Karnataka by making the RTI filing process simple, transparent, and accessible to every citizen. We believe that transparency is the cornerstone of democracy, and every Karnataka citizen has the right to access information from public authorities.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    To become Karnataka's most trusted platform for RTI filing, helping citizens across the state exercise their fundamental right to information. We envision a future where accessing Karnataka government information is as simple as a few clicks, fostering greater transparency and accountability.
                  </p>
                </div>
              </div>
            </div>
